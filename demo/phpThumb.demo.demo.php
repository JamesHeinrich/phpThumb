...
$only_gd2     = '<br>(only works with GD v2.0+, this server is running GD "<i>'.($ServerInfo['gd_string'] ? : 'n/a').'</i>" so it <b>'.(($ServerInfo[ 'gd_numeric'] >= 2) ? '<font color="green">will</font>' : '<font color="red">will not</font>').'</b> work)';
$only_gd2_im  = '<br>(only works with GD v2.0+ <i>or</i> ImageMagick, this server is running GD "<i>'.($ServerInfo['gd_string'] ? : 'n/a').'</i>" and ImageMagick "<i>'.($ServerInfo[ 'im_version'] ? : 'n/a').'</i>" so it <b>'.((($ServerInfo[ 'gd_numeric'] >= 2) || $ServerInfo[ 'im_version']) ? '<font color="green">will</font>' : '<font color="red">will not</font>').'</b> work)';
...
$php5_or_IM   = '<br>(only works with PHP v5.0.0+ <i>or</i> ImageMagick, this server is running PHP v'. PHP_VERSION .' and "<i>'.($ServerInfo[ 'im_version'] ? : 'n/a').'</i>" so it <b>'.((version_compare(PHP_VERSION, '5.0.0', '>=') || $ServerInfo[ 'im_version']) ? '<font color="green">will</font>' : '<font color="red">will not</font>').'</b> work (correctly))';
...
$only_im      = '<br>(requires ImageMagick, this server is running "<i>'.($ServerInfo['im_version'] ? : 'n/a').'</i>" so it <b>'.($ServerInfo[ 'im_version'] ? '<font color="green">will</font>' : '<font color="red">will not</font>').'</b> work)';
